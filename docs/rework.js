...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (window.innerWidth > 1440) {
    var adjustLayoutOnScroll = function adjustLayoutOnScroll() {
      if (glyphAnimationTriggers[0].getBoundingClientRect().top <= 0 && glyphAnimationTriggers[0].getBoundingClientRect().top >= glyphAnimationTriggers[0].offsetHeight * -1) {
        glyphSlotWidth.style.maxWidth = "".concat(scale(glyphAnimationTriggers[0].getBoundingClientRect().top * -1, 0, glyphAnimationTriggers[0].offsetHeight, 0, glyphMaxWidth), "px"); // glyphSlotWidth.style.borderRight = `1px solid rgba(0, 0, 0, ${scale(
        ...
        glyphSlotWidth.style.maxWidth = "".concat(glyphMaxWidth, "px"); // glyphSlotWidth.style.borderRight = `1px solid rgba(0, 0, 0, 1)`
      } else {
        glyphSlotWidth.style.maxWidth = "0px";
      }
    };
