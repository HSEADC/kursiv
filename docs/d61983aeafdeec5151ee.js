$(document).ready(function () {
  ...
  var sectionHeightTriple = sectionHeight * 3 - 500;
  var sectionHeightQuadriple = sectionHeight * 4 - 500;
  ...
  window.addEventListener('scroll', function (event) {
    ...
    if (sectionHeight - 100 <= result && result <= sectionHeightDouble - 100) {
    ...
    } else if (sectionHeightDouble - 100 <= result && result <= sectionHeightTriple - 100) {
      $(lis[0]).removeClass('active');
      ...
      $(lis[1]).removeClass('active');
    } else if (result >= sectionHeightTriple - 100 && result <= sectionHeightQuadriple - 100) {
      $(lis[0]).removeClass('active');
      $(lis[2]).removeClass('active');
